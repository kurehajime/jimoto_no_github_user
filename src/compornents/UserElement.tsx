...
export default function UserListElement(props: Props) {
    ...
    return (
        <div key={props.user.login}
            className="lg:max-w-3xl lg:min-w-3xl rounded-lg backdrop-blur-sm bg-gradient-to-r from-gray-50 to-gray-50 pl-3 mt-3 border border-green-500" >
            <div className="flex flex-row pb-1  pt-3 break-all">
